% Quasi-Static Magnetostatics Development Program
...
Volume = Lx*Ly*Lz;      % Element volume
...
tic;
DirichletBCEdges = FindDirichletBCEdgesZ(...
    EdgeNodesTable,...
    GlobalNodeNumbering,...
    TNEdge,...
    GlobalLx,...
...
% Plot Region 1
[R1Ax,R1Ay,R1Az,R1Bx,R1By,R1Bz,R1Hx,R1Hy,R1Hz,R1Energy] = ...
    PlotRegion(...
        InterpDiv,...
        mu_FreeSpace,...
        Volume,...
...
Region1Energy = sum(R1Energy)


% Plot Region 2
[R2Ax,R2Ay,R2Az,R2Bx,R2By,R2Bz,R2Hx,R2Hy,R2Hz,R2Energy] = ...
    PlotRegion(...
        InterpDiv,...
        mu_iron,...
        Volume,...
...
Region2Energy = sum(R2Energy)

% Plot Both Regions

PlotEdgeField(TNEL,...
    [Region2Elements;Region1Elements],...
    EdgeNodesTable,...
    GlobalNodeNumbering,...
    InterpDiv,...
    cat(4,R2Ax,R1Ax),cat(4,R2Ay,R1Ay),cat(4,R2Az,R1Az),...
    'm',...
...
PlotEdgeField(TNEL,...
    ...
    GlobalNodeNumbering,...
    InterpDiv,...
    cat(4,R2Bx,R1Bx),cat(4,R2By,R1By),cat(4,R2Bz,R1Bz),...
    'm',...
    'Magnetic Flux',...
    'B');
...
PlotEdgeField(TNEL,...
    ...
    GlobalNodeNumbering,...
    InterpDiv,...
    cat(4,R2Hx,R1Hx),cat(4,R2Hy,R1Hy),cat(4,R2Hz,R1Hz),...
    'm',...
